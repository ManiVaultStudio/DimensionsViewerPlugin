...
void DifferentialProfileWidget::updateData(const QModelIndex& begin, const QModelIndex& end, const QVector<int>& roles /*= QVector<int>()*/)
{
	...
	for (int column = begin.column(); column <= end.column(); column++) {
        ...
        if (column == to_ul(DifferentialProfile::Columns::Enabled)) {
        ...
        if (column == to_ul(DifferentialProfile::Columns::DatasetName1)) {
        ...
        if (column == to_ul(DifferentialProfile::Columns::DatasetName2)) {
        ...
        if (column == to_ul(DifferentialProfile::Columns::DatasetNames1)) {
        ...
        if (column == to_ul(DifferentialProfile::Columns::DatasetNames2)) {
